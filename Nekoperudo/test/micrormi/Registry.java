...
public class Registry {
    ...
    public void publish(int port) {
        if (server != null) {
            System.out.println("Pascal Socket is already connected to a server");
        }
    ...
    public Registry connect(String host, int port) {
        if (server != null) {
            System.out.println("Pascal Socket is already connected");
        }

        if (ss != null) {
            System.out.println("Pascal Registry is listening");
        }
